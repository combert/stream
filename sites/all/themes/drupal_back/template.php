 ...
 *   entirety and paste it here, changing the prefix from theme_ to drupal_back_.
 *   For example:
 *
 *     original: theme_breadcrumb()
 *     theme override: drupal_back_breadcrumb()
 *
 *   where drupal_back is the name of your sub-theme. For example, the
...
if (theme_get_setting('drupal_back_fixed')) {
  drupal_add_css(path_to_theme() . '/layout-fixed.css', 'theme', 'all');
}
// */

function drupal_back_admin_links() {
  global $user;
  if ($user->uid) {
    $links[0] = '<a style="color: #fff; text-decoration: none;" href="'. url('user') .'" class="user-name">'. $user->name .'</a>';
    $links[1] = '<a style="color: #fff; text-decoration: none;" href="'. url('logout') .'">'. t('Logout') .'</a>';
    //$links = implode(' | ', $links);
    return $links;
  }
}
 ...
 */
function drupal_back_theme(&$existing, $type, $theme, $path) {
...
function drupal_back_preprocess(&$vars, $hook) {
...
function drupal_back_preprocess_page(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
  
  $vars['admin_links'] = drupal_back_admin_links();
 ...
 */
/* -- Delete this line if you want to use this function
function drupal_back_preprocess_node(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function drupal_back_preprocess_comment(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
 ...
 */
/* -- Delete this line if you want to use this function
function drupal_back_preprocess_block(&$vars, $hook) {
  $vars['sample_variable'] = t('Lorem ipsum.');
}
// */
